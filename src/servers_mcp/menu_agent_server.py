...
# https://github.com/microsoft/semantic-kernel/blob/main/python/samples/concepts/mcp/servers/menu_agent_server.py
"""
...
class RestaurantPlugin:
    ...
    def list_restaurants(
        self,
    ) -> Annotated[str, "Returns a list of available restaurants."]:
        return """
