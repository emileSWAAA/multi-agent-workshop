...
{
    public class Ex04_Concurrent_Solution : IExerciseRunner
    {
        private readonly Kernel _kernel;

        public Ex04_Concurrent_Solution(Kernel kernel)
        {
            _kernel = kernel;
        }
        ...
        public async Task Run()
        {
            ...
            var orchestration = new ConcurrentOrchestration(productAgent, marketingAgent, ctoAgent)
            {
